...
The best way for you to make a decision about what’s good for t3rn is to have all of the information about what’s going on at t3rn. The same is true for everyone else you work with, so it’s important that we’re all up to date about what’s happening, even with the areas of t3rn that we’re not actively involved with.

Transparency may seem like a passive process, like "don’t hide anything," but it’s actually a big challenge to keep everyone up to date and on the same page, especially on projects they’re not working on on a daily basis, even for a company the size of t3rn. These are some of the policies we use to make information more accessible, but our work is ongoing.
...
This makes it easy to keep in the loop on projects and also keeps everyone at t3rn accountable to everyone else to do their part.
